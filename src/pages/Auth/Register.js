                ...
                <div className="row   ">
                    <div className="col-12 col-sm-6 col-md-6 w1  ms-auto me-auto  py-sm-4 py-md-0 py-4 rounded-3 shadow-lg bg-transparent mt-5 d-flex align-items-center justify-content-center flex-column " style={{ maxHeight: "73vh" }}>
                        ...
                        <form onSubmit={handleRegister}>
                            <div className="mb-2  border-start mb-4">
                                <input type="text" name='name' onChange={handleChange} className="py-1 fs form-control border-0 border-start border-primary border-5" placeholder='   |  Your name here!' id="exampleInputEmail1" aria-describedby="emailHelp" />
                            </div>
                            <div className="mb-2  border-start mb-4">
                            ...
                            <div className="text-center">
                                <button type="submit" disabled={isProcessing} className="btn mt- btn-primary fw-bold btn-hover px-4 fs-5 py-1">{isProcessing ? <div className='spinner-border spinner-border-sm mb-1'></div> : <>Take me in!</>}</button>
                    ...
                    <div className="col-12 col-sm-6 col-md-6 py-3 w2  ms-auto me-auto d-flex rounded-3 shadoww text-white bg align-items-center justify-content-center flex-column minus " style={{ minHeight: "79vh" }}>
                        ...
                        <div className='w2-text'>
                            ...
                            <div className='text-center'> <Link to={'/auth/login'} className='btn btn-bl btn-lg shadow-lg px-4 mt-1 btn-hover2  fw-bold' >LOGIN</Link>
                            </div>
                        </div>
                    </div>
                </div>
